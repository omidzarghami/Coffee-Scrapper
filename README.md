...
اسکرپر اخبار قهوه از [Global Coffee Report](https://www.gcrmag.com/) و [World Coffee Portal](https://www.worldcoffeeportal.com/latest). اولویت با اخبار **تکنولوژی / تحقیق / اتوماسیون** است؛ پیش‌نمایش مقاله با Gemini رایگان به فارسی ترجمه می‌شود و هر روز یک پست به کانال تلگرام ارسال می‌گردد.
...
1. تصویر + تیتر فارسی + تاریخ شمسی + منبع (`📰 گلوبال کافی ریپورت` یا ورلد کافی پورتال) + دکمه مطالعه اصل مقاله
2. ادامه ترجمه شماره‌دار (`📝 1- عنوان:`)
